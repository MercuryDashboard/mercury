...
$(function() {
    var dataGrid = $("#gridContainer").dxDataGrid({
        ...
        columns: [{
            ...
            allowResizing: true,
            //allowGrouping: false,
            allowHiding: false, //for columnChooser
            alignment: 'center',
    ...
    */
                        ...
                        cellTemplate: function(container, options) {
                            ...
                            if (options.data.dimension == 'Manual Release') {
                                ...
                                eButton.click(function() {
                                    //console.log(that);
                                    //console.log($(this).closest('.checkbox-container'));
                                    o.addClass('released');
    ...
    setTimeout(function(){
            ...
            /*var div11 = $('<div>',{'class':'dx-item dx-toolbar-item dx-toolbar-button dx-toolbar-item-auto-hide'}),
                div22 = $('<div>', {'class':'dx-item-content dx-toolbar-item-content'}),
                div33 = $('<div>', {'class':'dx-datagrid-toolbar-button dx-datagrid-export-button dx-button dx-button-normal dx-widget dx-button'}),
                div44 = $('<div>', {'class':'dx-button-content'}),
                unfold = $('<i>', {'class':'dx-icon dx-icon-chevrondown','html':' ','title':'Unfold All'});
            $(".dx-toolbar-after").append(div11.append(div22.append(div33.append(div44.append(unfold)))));
            */
