...
$(function() {
    ...
    $(".scenarioManagement").dxDataGrid({
        ...
        columns: [{
            ...
            AllowSorting: false,
            cellTemplate: function(container, options) {
                eventOpenRules(container, options);
            }
        }],
        masterDetail: {
            enabled: true,
                ...
                $("<div>")
                    ...
                    .dxDataGrid({
                        ...
                        columns: [{
                            ...
                            width: 70,
                            cellTemplate: function(container, options) {
                                eventFilterButton(container, options);
                            }
                        }]
                    }).appendTo(container);
            }
    ...
    var eventOpenRules = function(container, options) {
        var eButton = $('<button>', { 'class': 'btn btn-primary btn-xs waves-effect'}).click(function() {
            ...
            $.each(options.data.rules, function(i,v){
                var eOption = $('<option>'),
                    sValue = v.ruleName;
                $('.selectpicker').append(eOption.append(sValue));
            });
    ...
    var eventFilterButton = function(container, options) {
